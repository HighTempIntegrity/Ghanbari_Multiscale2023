...
STG = {	# Settings
	...
	'time_file':'5_time_locals.log',	# File name for saving all script duration values
}
SYS = {
	'command':'abaqus',
	'cpus':3,			# Number of logical processors to run the simulations
}
MS_LCL = {
...
time_log.in_right()
for local in local_events.locals:
	lcl_id = local['id']
